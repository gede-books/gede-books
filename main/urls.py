...
from main.views import purchased_books, purchased_books_ajax, show_main, show_guest, register, product_details, login_user, logout_user, add_to_cart, remove_from_cart, cart_view, show_xml, show_json, show_xml_by_id, show_json_by_id, tinggalkan_review, tinggalkan_review_flutter
