"""
Django settings for gede_books project.
...
SECRET_KEY = 'django-insecure--o52ruf-tox(m=j&824p$47)c&ih0n%mv)l!3+(zq8@46dif1r'
...
WSGI_APPLICATION = 'gede_books.wsgi.application'
